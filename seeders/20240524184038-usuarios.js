...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.bulkInsert('usuario', [
            ...
            { id: crypto.randomUUID(), email: 'patito@uv.mx', passwordhash: await bcrypt.hash('patito', 10), nombre: 'Usuario patito', rolid: UsuarioUUID, protegido: true, createdAt: new Date(), updatedAt: new Date() }
        ]);
    },
